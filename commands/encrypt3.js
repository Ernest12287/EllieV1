...
export default {
    name: 'encrypt3',
     aliases: ['obfuscate3', 'enc3'],
    description: 'Obfuscate JavaScript code (v3)',
    usage: '.encrypt <code>',
    category: 'Developer',
    ...
    async execute(sock, message, args) {
        ...
        try {
            ...
            const apiUrl = `https://api.giftedtech.co.ke/api/tools/encryptv3?apikey=gifted&code=${encodeURIComponent(code)}`;
